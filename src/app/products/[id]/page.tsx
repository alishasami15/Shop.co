...
// const handleAddToCart = (item: Product, selectedSize: string, selectedColor: string, addToCart: (item: CartItem) => void) => {
//   const router = useRouter();
...
const products: Product[] = [
  { title: "T-SHIRT WITH TAPE DETAILS", id: 1, price: 140, img3: "/images/image-1.png" },
   ...
   { title: "Courage Graphic T-Shirt", id: 12, price: 190, img3: "/white.png" },
   { title: "CHECKERED SHIRT", id: 10, price: 300,  img3: "/pink.png" },
  { title: "SLEEVE STRIPED T-SHIRT", id: 11, price: 150, img3: "/shirt-color.png" },
];
